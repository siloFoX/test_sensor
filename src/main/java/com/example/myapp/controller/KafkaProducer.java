...
public class KafkaProducer {
    ...
    // 1초마다 데이터를 Kafka 에 저장 및 로컬 버퍼에 저장
    ...
    public void setRecentSensorData (String recentSensorData) {
        ...
        try {
            Map mappedSensor = objectMapper.readValue(recentSensorData, new TypeReference<Map<String, String>>() {}); // Preprocess : Json to Map
    ...
    // todo : implement additional date data
}